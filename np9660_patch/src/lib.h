...
#define NF_LOG_DISABLED 0
#define NF_LOG_LITE 1
#define NF_LOG_FULL 2

void init_log(u32 log_level);
void (* lprintf)(const u32 log_level, const char *, ...);
...
int sceDdrdbSigvry(u8 *pubkey, u8 *hash, u8 *sig);
