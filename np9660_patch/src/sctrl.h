...
SceModule2 *(* _sceKernelFindModuleByAddress)(u32);
SceModule2 *(* _sceKernelFindModuleByName)(const char *);
SceModule2 *_sceKernelFindModuleByAddress_620(u32);
SceModule2 *_sceKernelFindModuleByAddress_660(u32);
SceModule2 *_sceKernelFindModuleByName_620(const char *);
SceModule2 *_sceKernelFindModuleByName_660(const char *);
